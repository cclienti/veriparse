...
ExternalProject_Add(openssl-url
    ...
    UPDATE_COMMAND    ""
    PATCH_COMMAND     ""
    CONFIGURE_COMMAND ../openssl-url/config --prefix=${OPENSSL_URL_INSTALL_DIR}
                                            --openssldir=${OPENSSL_URL_INSTALL_DIR}
    BUILD_COMMAND     make -j${OPENSSL_PROC}
