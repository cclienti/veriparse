# add_verilower_sv_cosim(NAME <design> [VERILATOR_ARGS <arg> ...])
#
# The verilower differential-bench convention: the behavioural source at
# test/verilower/<design>/src/<design>.sv is compiled by verilower with
# --suffix _lowered, and the bench at test/verilower/<design>/cosim/
# tb_<design>.sv (top module tb_<design>) drives source and lowered machine
# side by side. Registers test_cosim_<design>_svbench and exports the
# lowered netlist path as <design>_LOWERED_V in the parent scope.
#
# Requires add_sv_cosim_test.cmake and the verilower target.
...
function(add_verilower_sv_cosim)
    ...
    add_custom_command(
        ...
        COMMAND $<TARGET_FILE:verilower>
                ...
                ${_src}
        DEPENDS verilower ${_src}
        COMMENT "verilower ${AVSC_NAME} (renamed _lowered)"
        VERBATIM)
