...
TEST(VerilogGeneratorTest, sv_tf_typedef0) { TEST_CORE_SV; }
TEST(VerilogGeneratorTest, sv_type_param0) { TEST_CORE_SV; }
...
TEST(VerilogGeneratorTest, sv_interface_port2) { TEST_CORE_SV; }
