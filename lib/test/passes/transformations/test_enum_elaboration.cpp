...
#define TEST_CORE_SV                                                                               \
    ...
    test_helpers.render_node_to_dot_file(module, test_string + ".dot");                            \
                                                                                                   \
    /* Load the reference */                                                                       \
    std::string ref_filename = std::string("refs/enum_elaboration_") + test_name;                  \
...
TEST(PassesTransformation_EnumElaboration, enum_elaboration0) { TEST_CORE_SV; }
TEST(PassesTransformation_EnumElaboration, enum_elaboration1) { TEST_CORE_SV; }
