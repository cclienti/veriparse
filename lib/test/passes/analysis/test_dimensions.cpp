...
TEST(PassesAnalysis_Dimensions, dimension0)
{
    ...
    //--------------------------------------------
    Dimensions::DimList a_ref_dims{Dimensions::DimList::Decl::both, // decl
                                                                    // list
                                   {
    ...
    Dimensions::DimList b_ref_dims{Dimensions::DimList::Decl::var, // decl
                                                                   // list
                                   {
                                       // msb, lsb, width, is_big, is_packed
    ...
    Dimensions::DimList c_ref_dims{Dimensions::DimList::Decl::var, // decl
                                                                   // list
                                   {
                                       // msb, lsb, width, is_big, is_packed
    ...
    Dimensions::DimList d_ref_dims{Dimensions::DimList::Decl::var, // decl
                                                                   // list
                                   {
                                       // msb, lsb, width, is_big, is_packed
                                       {31, 0, 32, true, true}, // dim 0
...
TEST(PassesAnalysis_Dimensions, dimension1)
{
    ...
    rvalue_nodes->pop_front();
    {
        ...
        Dimensions::DimList ref_dims{Dimensions::DimList::Decl::var, // decl
                                                                     // list
                                     {
                                         // msb, lsb, width, is_big, is_packed
    ...
    for(int i = 0; i < 4; i++) {
        ...
        rvalue_nodes->pop_front();
        {
            ...
            Dimensions::DimList ref_dims{Dimensions::DimList::Decl::both, // decl
                                                                          // list
                                         {
                                             // msb, lsb, width, is_big, is_packed
                                             {7, 0, 8, true, true}, // dim 0
...
TEST(PassesAnalysis_Dimensions, gen_decl)
{
    ...
    //---------------------------------------------------
    Dimensions::DimList dims_a{Dimensions::DimList::Decl::var, // decl
                                                               // list
                               {
                                   // msb, lsb, width, is_big, is_packed
                                   {87, 0, 88, true, true}, // dim 0
    ...
    //---------------------------------------------------
    Dimensions::DimList dims_b{Dimensions::DimList::Decl::var, // decl
                                                               // list
                               {
                                   // msb, lsb, width, is_big, is_packed
                                   {3, 0, 4, true, true}, // dim 1
