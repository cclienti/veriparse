...
TEST(VerilogNumberParserTest, intconst7)
{
    ...
    ASSERT_EQ(verilog_number.parse("32'hDeAd_BeAf", mpz, size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 32);
    ASSERT_EQ(base, 16);
    ASSERT_EQ(is_signed, false);
...
TEST(VerilogNumberParserTest, intconst8)
{
    ...
    ASSERT_EQ(verilog_number.parse("32'SHDeAd_BeAf", mpz, size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 32);
    ASSERT_EQ(base, 16);
    ASSERT_EQ(is_signed, true);
...
TEST(VerilogNumberParserTest, intconst9)
{
    ...
    bool is_signed;
    int rc;
    mpz_class mpz_ref("0xfedcba9876543210abcdfedcba9876543210abcd");

    ASSERT_EQ(verilog_number.parse("160'hfedc_ba98_7654_3210_abcd_fedc_ba98_7654_3210_abcd", mpz,
                                   size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 160);
    ASSERT_EQ(base, 16);
    ASSERT_EQ(is_signed, false);
...
TEST(VerilogNumberParserTest, intconst10)
{
    ...
    bool is_signed;
    int rc;
    mpz_class mpz_ref("-6495562832581790688766959896882149561576936499");

    ASSERT_EQ(verilog_number.parse("160'shfedc_ba98_7654_3210_abcd_fedc_ba98_7654_3210_abcd", mpz,
                                   size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 160);
    ASSERT_EQ(base, 16);
...
TEST(VerilogNumberParserTest, intconst12)
{
    ...
    ASSERT_EQ(verilog_number.parse("24'sO71234567", mpz, size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 24);
    ASSERT_EQ(base, 8);
    ASSERT_EQ(is_signed, true);
...
TEST(VerilogNumberParserTest, intconst13)
{
    ...
    bool is_signed;
    int rc;
    mpz_class mpz_ref("0xfedcba9876543210abcdfedcba9876543210abcd0");

    ASSERT_EQ(
        verilog_number.parse(
            "164'"
            "b1111111011011100101110101001100001110110010101000011001000010000101010111100110111111"
            "1101101110010111010100110000111011001010100001100100001000010101011110011010000",
            mpz, size, base, is_signed, rc, "test.v", 4),
        0);
    ASSERT_EQ(size, 164);
    ASSERT_EQ(base, 2);
    ASSERT_EQ(is_signed, false);
...
TEST(VerilogNumberParserTest, intconst14)
{
    ...
    ASSERT_EQ(
        verilog_number.parse(
            "164'"
            "sb111111101101110010111010100110000111011001010100001100100001000010101011110011011111"
            "11101101110010111010100110000111011001010100001100100001000010101011110011010000",
            mpz, size, base, is_signed, rc, "test.v", 4),
        0);
    ASSERT_EQ(size, 164);
    ASSERT_EQ(base, 2);
...
TEST(VerilogNumberParserTest, intconst15)
{
    ...
    bool is_signed;
    int rc;
    mpz_class mpz_ref("0xedcba9876543210abcdfedcba9876543210abcd0");
...
TEST(VerilogNumberParserTest, intconst18)
{
    ...
    ASSERT_EQ(verilog_number.parse("32'h0100_??Xz", mpz, size, base, is_signed, rc, "test.v", 4),
              0);
    ASSERT_EQ(size, 32);
    ASSERT_EQ(base, 16);
    ASSERT_EQ(is_signed, false);
