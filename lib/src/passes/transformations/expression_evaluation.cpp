...
ExpressionEvaluation::ExpressionEvaluation(const ReplaceMap &replace_map,
    ...
    : m_replace_map(replace_map), m_function_map(function_map)
{
}
...
bool ExpressionEvaluation::evaluate_node(const AST::Node::Ptr &node, mpz_class &value)
{
    ...
    if(eval_node) {
        ...
        case AST::NodeType::FloatConst:
            // cpp_int has no direct construction from double; truncate via
            // our helper, which is safe over the full double range (the
            // naive static_cast<long long>(d) would be UB for |d| >= 2^63).
            value = Misc::double_to_bignum(AST::cast_to<AST::FloatConst>(eval_node)->get_value());
            return true;
...
bool ExpressionEvaluation::evaluate_node(const AST::Node::Ptr &node, double &value)
{
    ...
    if(eval_node) {
        switch(eval_node->get_node_type()) {
        case AST::NodeType::IntConstN:
            value = AST::cast_to<AST::IntConstN>(eval_node)->get_value().convert_to<double>();
            return true;
...
AST::Node::Ptr ExpressionEvaluation::evaluate_node(const AST::Node::Ptr node)
{
    if(node) {
        if(node->is_node_type(AST::NodeType::Cond)) {
            ...
            AST::IntConstN::Ptr var =
                AST::cast_to<AST::IntConstN>(evaluate_node(pointer_node->get_var()));
            AST::IntConstN::Ptr ptr =
                AST::cast_to<AST::IntConstN>(evaluate_node(pointer_node->get_ptr()));
            ...
            AST::IntConstN::Ptr var =
                AST::cast_to<AST::IntConstN>(evaluate_node(partselect_node->get_var()));
            AST::IntConstN::Ptr msb =
                AST::cast_to<AST::IntConstN>(evaluate_node(partselect_node->get_msb()));
            AST::IntConstN::Ptr lsb =
                AST::cast_to<AST::IntConstN>(evaluate_node(partselect_node->get_lsb()));
            ...
            AST::PartselectIndexed::Ptr partselect_node =
                AST::cast_to<AST::PartselectIndexed>(node);
                                                            ...
                                                            const AST::Node::Ptr node0)
{
    ...
    case AST::NodeType::Uplus:
        return expression_operator_unary<uplus>(node0);
    case AST::NodeType::Uminus:
        return expression_operator_unary<uminus>(node0);
    case AST::NodeType::Ulnot:
        return expression_operator_unary_nofloat<ulnot>(node0);
    case AST::NodeType::Unot:
        return expression_operator_unary_nofloat<unot>(node0);
    case AST::NodeType::Uand:
        return expression_operator_unary_nofloat<uand>(node0);
    case AST::NodeType::Unand:
        return expression_operator_unary_nofloat<unand>(node0);
    case AST::NodeType::Uor:
        return expression_operator_unary_nofloat<uor>(node0);
    case AST::NodeType::Unor:
        return expression_operator_unary_nofloat<unor>(node0);
    case AST::NodeType::Uxor:
        return expression_operator_unary_nofloat<uxor>(node0);
    case AST::NodeType::Uxnor:
        return expression_operator_unary_nofloat<uxnor>(node0);
    default:
        return nullptr;
    }
}
                                                            ...
                                                            const AST::Node::Ptr node1)
{
    ...
    case AST::NodeType::Power:
        return expression_operator_binary<power>(node0, node1);
    case AST::NodeType::Times:
        return expression_operator_binary<times>(node0, node1);
    case AST::NodeType::Divide:
        return expression_operator_binary<divide>(node0, node1);
    case AST::NodeType::Mod:
        return expression_operator_binary<mod>(node0, node1);
    case AST::NodeType::Plus:
        return expression_operator_binary<plus>(node0, node1);
    case AST::NodeType::Minus:
        return expression_operator_binary<minus>(node0, node1);
    case AST::NodeType::Sll:
        return expression_operator_binary_nofloat<sll>(node0, node1);
    case AST::NodeType::Srl:
        return expression_operator_binary_nofloat<srl>(node0, node1);
    case AST::NodeType::Sra:
        return expression_operator_binary_nofloat<sra>(node0, node1);
    case AST::NodeType::LessThan:
        return expression_operator_binary<less_than>(node0, node1);
    case AST::NodeType::GreaterThan:
        return expression_operator_binary<greater_than>(node0, node1);
    case AST::NodeType::LessEq:
        return expression_operator_binary<less_equal>(node0, node1);
    case AST::NodeType::GreaterEq:
        return expression_operator_binary<greater_equal>(node0, node1);
    case AST::NodeType::Eq:
        return expression_operator_binary<equal>(node0, node1);
    case AST::NodeType::NotEq:
        return expression_operator_binary<not_equal>(node0, node1);
    case AST::NodeType::Eql:
        return expression_operator_binary_nofloat<case_equal>(node0, node1);
    case AST::NodeType::NotEql:
        return expression_operator_binary_nofloat<case_not_equal>(node0, node1);
    case AST::NodeType::And:
        return expression_operator_binary_nofloat<bitwise_and>(node0, node1);
    case AST::NodeType::Xor:
        return expression_operator_binary_nofloat<bitwise_xor>(node0, node1);
    case AST::NodeType::Xnor:
        return expression_operator_binary_nofloat<bitwise_xnor>(node0, node1);
    case AST::NodeType::Or:
        return expression_operator_binary_nofloat<bitwise_or>(node0, node1);
    case AST::NodeType::Land:
        return expression_operator_binary<logical_and>(node0, node1);
    case AST::NodeType::Lor:
        return expression_operator_binary<logical_or>(node0, node1);
    default:
        return nullptr;
    }
}
                                                            ...
                                                            const AST::Node::Ptr node2)
{
    ...
    case AST::NodeType::Cond:
        return expression_operator_ternary<ternary>(node0, node1, node2);
    case AST::NodeType::PartselectMinusIndexed: {
        partselect_minus<AST::IntConstN::Ptr> op;
        return op(AST::cast_to<AST::IntConstN>(node0), AST::cast_to<AST::IntConstN>(node1),
