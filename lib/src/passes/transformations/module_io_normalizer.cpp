...
AST::Variable::Ptr ModuleIONormalizer::create_default_net_type_variable(
    AST::Module::Default_nettypeEnum defnt, AST::Width::ListPtr widths, const std::string &name)
{
    AST::Variable::Ptr var;
