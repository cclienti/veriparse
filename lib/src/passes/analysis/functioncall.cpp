...
AST::Identifier::ListPtr
FunctionCall::get_argument_identifier_nodes(AST::FunctionCall::Ptr functioncall)
{
...
FunctionCall::get_argument_identifier_names(AST::FunctionCall::Ptr functioncall)
{
