...
bool UniqueDeclaration::identifier_declaration_exists(const std::string &identifier,
                                                      const IdentifierSet &id_set)
{
    return id_set.count(identifier) != 0;
}

std::string UniqueDeclaration::get_unique_identifier(const std::string &identifier_basename,
                                                     IdentifierSet &id_set, std::size_t digits)
{
