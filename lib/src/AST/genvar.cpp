...
bool Genvar::operator!=(const Genvar &rhs) const { return !(operator==(rhs)); }

bool Genvar::operator!=(const Node &rhs) const { return !(operator==(rhs)); }

bool Genvar::remove(Node::Ptr node) { return replace(node, AST::Node::Ptr(nullptr)); }
