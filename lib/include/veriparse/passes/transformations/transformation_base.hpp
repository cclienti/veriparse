...
public:
     ...
     */
    virtual int run(AST::Node::Ptr node) { return process(node, nullptr); }
...
protected:
     ...
     * @return zero on success.
     */
    virtual int recurse(AST::Node::Ptr parent, AST::Node::ListPtr node_list,
     ...
     * @return nothing.
     */
    virtual void pickup_statements(AST::Node::Ptr parent, AST::Node::Ptr node, AST::Node::Ptr stmt);
};
