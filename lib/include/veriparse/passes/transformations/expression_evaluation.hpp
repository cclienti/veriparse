...
public:
     ...
     */
    ExpressionEvaluation(const ReplaceMap &replace_map, const FunctionMap &function_map);
...
private:
     ...
     */
    AST::Node::Ptr evaluate_system_call(const std::string &call, const AST::Node::ListPtr args,
     ...
     */
    AST::Node::Ptr evaluate_constant_node(const AST::NodeType operation, const AST::Node::Ptr node0,
     ...
     */
    AST::Node::Ptr evaluate_constant_node(const AST::NodeType operation, const AST::Node::Ptr node0,
                                          const AST::Node::Ptr node1, const AST::Node::Ptr node2);
