...
private:
    ...
    virtual std::string render_datatype(const AST::DataType::Ptr node) const;
    ...
    virtual std::string render_dimension(const AST::Dimension::Ptr node) const;
    ...
    virtual std::string render_declaration(const AST::Declaration::Ptr node) const;
    ...
    virtual std::string render_unaryoperator(const AST::UnaryOperator::Ptr node) const;
    ...
    virtual std::string render_operator(const AST::Operator::Ptr node) const;
