...
#define VERIPARSE_LOG(severity)                                                                    \
    BOOST_LOG_SEV(Veriparse::Logger::logger::get(), boost::log::trivial::severity)                 \
        << "[" << Veriparse::Logger::get_class_name(VERIPARSE_FUNCTION_NAME) << "] "

// Log Macros
#define LOG_TRACE                                                                                  \
    if(Veriparse::Logger::trace_enabled())                                                         \
    VERIPARSE_LOG(trace)
#define LOG_TRACE_F(_1) LOG_TRACE << "file " << _1 << ", "
#define LOG_TRACE_FL(_1, _2) LOG_TRACE << "file " << _1 << ':' << _2 << ", "
#define LOG_TRACE_N(_1)                                                                            \
    if(_1)                                                                                         \
    LOG_TRACE_FL(_1->get_filename(), _1->get_line())
...
#define LOG_DEBUG_N(_1)                                                                            \
    if(_1)                                                                                         \
    LOG_DEBUG_FL(_1->get_filename(), _1->get_line())

#define LOG_INFO                                                                                   \
    if(Veriparse::Logger::info_enabled())                                                          \
    VERIPARSE_LOG(info)
#define LOG_INFO_F(_1) LOG_INFO << "file " << _1 << ", "
#define LOG_INFO_FL(_1, _2) LOG_INFO << "file " << _1 << ':' << _2 << ", "
#define LOG_INFO_N(_1)                                                                             \
    if(_1)                                                                                         \
    LOG_INFO_FL(_1->get_filename(), _1->get_line())

#define LOG_WARNING                                                                                \
    if(Veriparse::Logger::warning_enabled())                                                       \
    VERIPARSE_LOG(warning)
#define LOG_WARNING_F(_1) LOG_WARNING << "file " << _1 << ", "
#define LOG_WARNING_FL(_1, _2) LOG_WARNING << "file " << _1 << ':' << _2 << ", "
#define LOG_WARNING_N(_1)                                                                          \
    if(_1)                                                                                         \
    LOG_WARNING_FL(_1->get_filename(), _1->get_line())
...
#define LOG_ERROR_N(_1)                                                                            \
    if(_1)                                                                                         \
    LOG_ERROR_FL(_1->get_filename(), _1->get_line())
...
#define LOG_FATAL_N(_1)                                                                            \
    if(_1)                                                                                         \
    LOG_FATAL_FL(_1->get_filename(), _1->get_line())
...
BOOST_LOG_GLOBAL_LOGGER(
    logger, boost::log::sources::severity_logger_mt<boost::log::trivial::severity_level>)
