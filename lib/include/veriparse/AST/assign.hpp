...
public:
     ...
     * Constructor, m_node_type is set to NodeType::Assign.
     */
    Assign(const Lvalue::Ptr left, const Rvalue::Ptr right, const DelayStatement::Ptr ldelay,
           const DelayStatement::Ptr rdelay, const std::string &filename = "", uint32_t line = 0);
     ...
     */
    virtual void set_left(Lvalue::Ptr left) { m_left = left; }
