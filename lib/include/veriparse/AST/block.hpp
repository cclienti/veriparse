...
#ifndef VERIPARSE_AST_BLOCK_HPP
#define VERIPARSE_AST_BLOCK_HPP
...
public:
     ...
     */
    Block(const std::string &filename = "", uint32_t line = 0);

    /**
     * Constructor, m_node_type is set to NodeType::Block.
     */
    Block(const Node::ListPtr statements, const std::string &scope,
    ...
    /**
     * Return true if the Block nodes are the same, do not check children.
     */
