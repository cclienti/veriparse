...
public:
     ...
     * Constructor, m_node_type is set to NodeType::Ioport.
     */
    Ioport(const IODir::Ptr first, const Variable::Ptr second, const std::string &filename = "",
           uint32_t line = 0);
     ...
     */
    virtual void set_first(IODir::Ptr first) { m_first = first; }

    /**
     * Change the child second.
     */
    virtual void set_second(Variable::Ptr second) { m_second = second; }
