#ifndef VERIPARSE_AST_TIMES_HPP
#define VERIPARSE_AST_TIMES_HPP
...
public:
	 ...
	 */
	Times(const std::string &filename="", uint32_t line=0);
	
	/**
	 * Constructor, m_node_type is set to NodeType::Times.
	 */
	Times(const Node::Ptr left, const Node::Ptr right, const std::string &filename="", uint32_t line=0);
	

	/**
	 * Assignment operator, do not affect children.
	 */
	virtual Times &operator=(const Times &rhs);
	...
	/**
	 * Return true if the Times nodes are the same, do not check children.
	 */
	virtual bool operator==(const Times &rhs) const;
