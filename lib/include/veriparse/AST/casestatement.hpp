...
public:
     ...
     * Constructor, m_node_type is set to NodeType::CaseStatement.
     */
    CaseStatement(const Node::Ptr comp, const Case::ListPtr caselist,
     ...
     */
    virtual void set_comp(Node::Ptr comp) { m_comp = comp; }

    /**
     * Change the child caselist.
     */
    virtual void set_caselist(Case::ListPtr caselist) { m_caselist = caselist; }
