...
#ifndef VERIPARSE_AST_ALWAYS_HPP
#define VERIPARSE_AST_ALWAYS_HPP
...
public:
     ...
     */
    Always(const std::string &filename = "", uint32_t line = 0);

    /**
     * Constructor, m_node_type is set to NodeType::Always.
     */
    Always(const Senslist::Ptr senslist, const Node::Ptr statement,
           const std::string &filename = "", uint32_t line = 0);

    /**
     * Assignment operator, do not affect children.
     */
    virtual Always &operator=(const Always &rhs);
    ...
    /**
     * Return true if the Always nodes are the same, do not check children.
     */
    virtual bool operator==(const Always &rhs) const;
     ...
     */
    virtual void set_senslist(Senslist::Ptr senslist) { m_senslist = senslist; }
