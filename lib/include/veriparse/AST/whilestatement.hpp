...
#ifndef VERIPARSE_AST_WHILESTATEMENT_HPP
#define VERIPARSE_AST_WHILESTATEMENT_HPP
...
public:
     ...
     */
    WhileStatement(const std::string &filename = "", uint32_t line = 0);

    /**
     * Constructor, m_node_type is set to NodeType::WhileStatement.
     */
    WhileStatement(const Node::Ptr cond, const Node::Ptr statement,
                   const std::string &filename = "", uint32_t line = 0);

    /**
     * Assignment operator, do not affect children.
     */
    virtual WhileStatement &operator=(const WhileStatement &rhs);
    ...
    /**
     * Return true if the WhileStatement nodes are the same, do not check children.
     */
    virtual bool operator==(const WhileStatement &rhs) const;
     ...
     */
    virtual void set_cond(Node::Ptr cond) { m_cond = cond; }
