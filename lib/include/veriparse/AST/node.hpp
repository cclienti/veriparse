...
public:
     ...
     */
    virtual NodeType get_node_type(void) const { return m_node_type; }

    /**
     * Return true if the given node type corresponds to the type
     * of the node.
     */
    virtual bool is_node_type(NodeType node_type) const { return m_node_type == node_type; }

    /**
     * Return true if the given node category corresponds to the
     * category of the node.
     */
    virtual const std::vector<NodeType> &get_node_categories() const { return m_node_categories; }
...
protected:
     ...
     */
    void set_node_type(NodeType node_type) { m_node_type = node_type; }
