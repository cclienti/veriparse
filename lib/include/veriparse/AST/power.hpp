#ifndef VERIPARSE_AST_POWER_HPP
#define VERIPARSE_AST_POWER_HPP
...
namespace Veriparse {
	namespace AST {
		...
		public:
			 ...
			 */
			Power(const std::string &filename="", uint32_t line=0);
			
			/**
			 * Constructor, m_node_type is set to NodeType::Power.
			 */
			Power(const Node::Ptr left, const Node::Ptr right, const std::string &filename="", uint32_t line=0);
			

			/**
			 * Assignment operator, do not affect children.
			 */
			virtual Power &operator=(const Power &rhs);
			...
			/**
			 * Return true if the Power nodes are the same, do not check children.
			 */
