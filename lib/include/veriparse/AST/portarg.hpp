#ifndef VERIPARSE_AST_PORTARG_HPP
#define VERIPARSE_AST_PORTARG_HPP
...
namespace Veriparse {
	namespace AST {
		...
		public:
			 ...
			 */
			PortArg(const std::string &filename="", uint32_t line=0);
			
			/**
			 * Constructor, m_node_type is set to NodeType::PortArg.
			 */
			PortArg(const Node::Ptr value, const std::string &name, const std::string &filename="", uint32_t line=0);
			

			/**
			 * Assignment operator, do not affect children.
			 */
			virtual PortArg &operator=(const PortArg &rhs);
			...
			/**
			 * Return true if the PortArg nodes are the same, do not check children.
			 */
			virtual bool operator==(const PortArg &rhs) const;
