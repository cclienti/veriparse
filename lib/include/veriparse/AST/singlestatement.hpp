...
public:
     ...
     * Constructor, m_node_type is set to NodeType::SingleStatement.
     */
    SingleStatement(const Node::Ptr statement, const DelayStatement::Ptr delay,
                    const std::string &scope, const std::string &filename = "", uint32_t line = 0);
     ...
     */
    virtual void set_delay(DelayStatement::Ptr delay) { m_delay = delay; }
