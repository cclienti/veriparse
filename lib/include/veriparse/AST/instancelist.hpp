...
public:
     ...
     * Constructor, m_node_type is set to NodeType::Instancelist.
     */
    Instancelist(const ParamArg::ListPtr parameterlist, const Instance::ListPtr instances,
                 const std::string &module, const std::string &filename = "", uint32_t line = 0);
     ...
     */
    virtual void set_instances(Instance::ListPtr instances) { m_instances = instances; }
