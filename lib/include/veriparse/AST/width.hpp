...
public:
     ...
     * Constructor, m_node_type is set to NodeType::Width.
     */
    Width(const Node::Ptr msb, const Node::Ptr lsb, const std::string &filename = "",
          uint32_t line = 0);
     ...
     */
    virtual void set_msb(Node::Ptr msb) { m_msb = msb; }

    /**
     * Change the child lsb.
     */
    virtual void set_lsb(Node::Ptr lsb) { m_lsb = lsb; }
