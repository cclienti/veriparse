#ifndef VERIPARSE_AST_CONSTANT_HPP
#define VERIPARSE_AST_CONSTANT_HPP
...
public:
	 ...
	 */
	Constant(const std::string &filename="", uint32_t line=0);
	

	/**
	 * Assignment operator, do not affect children.
	 */
	virtual Constant &operator=(const Constant &rhs);
	...
	/**
	 * Return true if the Constant nodes are the same, do not check children.
	 */
	virtual bool operator==(const Constant &rhs) const;
