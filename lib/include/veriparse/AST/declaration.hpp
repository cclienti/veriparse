...
#ifndef VERIPARSE_AST_DECLARATION_HPP
#define VERIPARSE_AST_DECLARATION_HPP
...
{
public:
    using Ptr = typename NodePointers<Declaration>::Ptr;
    using List = typename NodePointers<Declaration>::List;
    using ListPtr = typename NodePointers<Declaration>::ListPtr;
    using Node::operator=;
    using Node::operator==;
    using Node::operator!=;
     ...
     */
    Declaration(const std::string &filename = "", uint32_t line = 0);
     ...
     */
    virtual Declaration &operator=(const Declaration &rhs);
    ...
    /**
     * Return true if the Declaration nodes are the same, do not check children.
     */
    virtual bool operator==(const Declaration &rhs) const;
