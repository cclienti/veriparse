...
public:
     ...
     * Constructor, m_node_type is set to NodeType::ForStatement.
     */
    ForStatement(const BlockingSubstitution::Ptr pre, const Node::Ptr cond,
     ...
     */
    virtual void set_pre(BlockingSubstitution::Ptr pre) { m_pre = pre; }
     ...
     */
    virtual void set_post(BlockingSubstitution::Ptr post) { m_post = post; }
