...
#ifndef VERIPARSE_AST_IMPLICITTYPE_HPP
...
public:
     ...
     */
    ImplicitType(const std::string &filename = "", uint32_t line = 0);
     ...
     */
    virtual ImplicitType &operator=(const ImplicitType &rhs);
    ...
    /**
     * Return true if the ImplicitType nodes are the same, do not check children.
     */
    virtual bool operator==(const ImplicitType &rhs) const;
